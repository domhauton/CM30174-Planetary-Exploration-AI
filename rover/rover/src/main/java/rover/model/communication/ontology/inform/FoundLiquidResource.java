 ...
 */
public class FoundLiquidResource implements MessageParser {
  private static int REQUIRED_LENGTH = 4;
  public static String PHRASE = "FOUND_LIQUID_RESOURCE";
  ...
  public Optional<Runnable> parse(String[] message, MessageReceiver messageReceiver) {
    return Optional.of(() -> messageReceiver.newLiquidResourceFound(
