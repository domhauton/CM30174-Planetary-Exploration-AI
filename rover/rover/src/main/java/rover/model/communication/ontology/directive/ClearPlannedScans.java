 ...
 */
public class ClearPlannedScans implements MessageParser{
  private static int REQUIRED_LENGTH = 1;
  public static String PHRASE = "CLEAR_PLANNED_SCANS";
  ...
  public Optional<Runnable> parse(String[] message, MessageReceiver messageReceiver) {
    return Optional.of(messageReceiver::clearPlannedScans);
  }
